-- Update user_quotas table to remove 'free' plan
-- Update check constraint to only allow: demo, pro, enterprise
...
-- Update existing 'free' plans to 'demo' (if any exist)
UPDATE user_quotas
SET 
  plan_type = 'demo',
...
-- Update the upgrade_user_plan function to remove free option
...
-- Update check_user_quota function to handle only demo/pro/enterprise
...
-- Update reset_monthly_quotas to only reset pro/enterprise
